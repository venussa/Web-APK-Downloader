...
<a href="<?php echo getPermalink()->homeUrl()?>/<?=$list_order->categori?>/<?=$list_order->url?>" class="view-more" style="text-decoration: none;margin-top:-70px;margin-right:-8px">View More</a>
<div >
...
?>
<div class="col-md-4 art-ls" ctl="<?=$ctl?>" data="<?=$by?>" cat="<?=$_POST['cat']?>">
